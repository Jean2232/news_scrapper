...
async function globo_e_fut(){
  ...
  $('div > ._evg > ._evt > div > ._evg > ._evt').each((i, e) => {
    ...
    }catch{var dateform = post}

    if (num_min == "9" ||num_min == "8" ||num_min == "7" || num_min == "6" || num_min == "5" || num_min == "4" || num_min == "3" || num_min == "2" || num_min == "1" && min_h == "minutos" ){
      var dados = { title, content, post, link };
      results.push(dados);
      console.log(results)}})}
